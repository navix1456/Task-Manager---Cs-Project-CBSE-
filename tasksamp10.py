...
def search_task():
    ...
    if priority_value and priority_value.isdigit():
        ...
        priority = (
            3  # Assign a default value if priority is not selected or not a valid digit
        )
...
scrollbar = ttk.Scrollbar(list_frame, orient="vertical", command=task_tree.yview)
task_tree.configure(yscrollcommand=scrollbar.set)

# Your existing Treeview configuration
